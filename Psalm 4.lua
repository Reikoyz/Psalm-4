...
function SendNotification(text)
    Notification:Notify(
        {Title = "FrostByte", Description = "coolest kid - "..text},
...
task.spawn(function()
    ...
    watermark:Update { "FrostByte", ScriptProperties.UserPanel.Status, frames .. " FPS", string.format("%s:%s %s", tonumber(os.date("%I")), os.date("%M"), os.date("%p")) }
